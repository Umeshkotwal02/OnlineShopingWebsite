...
import { AccountIcon, WishlistIcon, CartIcon, SearchIcon, LoginIcon, Dropdown } from "./SvgIcons";
import Menu from "../Components/headercomp/CategoryMenu";
  ...
  return (
    <>
      <header className="sticky-top" style={{ backgroundColor: "#F3F3F3" }}>
        <Row className="align-items-center py-2 ms-4 me-4 e">
          {/* Logo Section */}
          ...
          <Col xxl={5} xl={5} className="flex-grow-1 my-2">
            ...
            >
              ...
              <input
                ...
                className="form-control border-0 bg-transparent text-dark search-hover search-input"
                value={searchTerm}
